...
let
  sources = {
    ...
    "ssb-db-20.0.1" = {
      ...
      version = "20.0.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/ssb-db/-/ssb-db-20.0.1.tgz";
        sha512 = "KA1JVxWMeZr3mXwN8PFba53vtBI+P3Y/cpy25IupU2vWi1l+Z3UOuV690cpavRoy9NW4BUc8Lpy38r21Ul3eIA==";
      };
    };
    "ssb-db2-1.16.2" = {
      name = "ssb-db2";
...
in
{
  "ssb-server-15.2.0" = nodeEnv.buildNodePackage {
    name = "ssb-server";
  ...
  "ssb-server-patch-git+https://github.com/icetan/ssb-server.git#pin-ssb-db-20-0-1" = nodeEnv.buildNodePackage {
    name = "ssb-server";
    packageName = "ssb-server";
    version = "16.0.1";
    src = fetchgit {
      url = "https://github.com/icetan/ssb-server.git";
      rev = "e0853fdb70880758a8329acca91b516d0f2ae31b";
      sha256 = "d9925d17c1f9cb749b0cdb8951145317bc801f8531252c8e482c3d5c5628a6fa";
    };
    dependencies = [
      (sources."@sammacbeth/random-access-idb-mutable-file-0.1.1" // {
        dependencies = [
